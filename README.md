...
Emlang is a toy programming language I am working on as a lerning exercise. This will be an interpreted language build following along with the [Crafting Interpreters](https://craftinginterpreters.com/) book.

I will use python3 for this implementation, as its what I am currently most familar and it is different to the language used in the book. This way I need to understand each aspect and will not copy and code directly.
